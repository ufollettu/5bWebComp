...
div: {
  ...
  <span class="hljs-string">'right: '</span><span class="hljs-number">0</span><span class="hljs-string">',
...
used. Otherwise we recommend to rely on <code>hsl</code> or <code>hsla</code>.</p>
  ...
  <div class='pre p1 fill-light mt0'>hslToColorString(color: (<a href="#hslcolor">HslColor</a> | <a href="#hslacolor">HslaColor</a> | <a href="https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/Number">number</a>)): <a href="https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/String">string</a></div>
    ...
    <div class='py1 quiet mt1 prose-big'>Example</div>
      ...
      <pre class='p1 overflow-auto round fill-light'><span class="hljs-comment">// Styles as object usage</span>
<span class="hljs-keyword">const</span> styles = {
  <span class="hljs-built_in">background</span>: hslToColorString({ <span class="hljs-built_in">hue</span>: <span class="hljs-number">240</span>, <span class="hljs-built_in">saturation</span>: <span class="hljs-number">1</span>, lightness: <span class="hljs-number">0.5</span> }),
  <span class="hljs-built_in">background</span>: hslToColorString({ <span class="hljs-built_in">hue</span>: <span class="hljs-number">360</span>, <span class="hljs-built_in">saturation</span>: <span class="hljs-number">0.75</span>, lightness: <span class="hljs-number">0.4</span>, <span class="hljs-built_in">alpha</span>: <span class="hljs-number">0.72</span> }),
}
...
used. Otherwise we recommend to rely on <code>rgb</code> or <code>rgba</code>.</p>
  ...
  <div class='pre p1 fill-light mt0'>rgbToColorString(color: (<a href="#rgbcolor">RgbColor</a> | <a href="#rgbacolor">RgbaColor</a>)): <a href="https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/String">string</a></div>
    ...
    <div class='py1 quiet mt1 prose-big'>Example</div>
      ...
      <pre class='p1 overflow-auto round fill-light'><span class="hljs-comment">// Styles as object usage</span>
<span class="hljs-keyword">const</span> styles = {
  <span class="hljs-built_in">background</span>: rgbToColorString({ <span class="hljs-built_in">red</span>: <span class="hljs-number">255</span>, <span class="hljs-built_in">green</span>: <span class="hljs-number">205</span>, <span class="hljs-built_in">blue</span>: <span class="hljs-number">100</span> }),
  <span class="hljs-built_in">background</span>: rgbToColorString({ <span class="hljs-built_in">red</span>: <span class="hljs-number">255</span>, <span class="hljs-built_in">green</span>: <span class="hljs-number">205</span>, <span class="hljs-built_in">blue</span>: <span class="hljs-number">100</span>, <span class="hljs-built_in">alpha</span>: <span class="hljs-number">0.72</span> }),
}
...
<span class="hljs-selector-tag">div</span> {
  ...
  <span class="hljs-string">'borderStyle'</span>: <span class="hljs-string">'solid'</span>,
  <span class="hljs-string">'borderWidth'</span>: `<span class="hljs-number">1px</span>`,
}

<span class="hljs-comment">// Styles as object usage</span>
const styles = {
  ...<span class="hljs-attribute">border</span>(<span class="hljs-string">'top'</span>, <span class="hljs-string">'1px'</span>, <span class="hljs-string">'solid'</span>, <span class="hljs-string">'red'</span>)
}
...
<span class="hljs-keyword">const</span> styles = {
  ...
  ...transitions([<span class="hljs-symbol">'color</span>', <span class="hljs-symbol">'background</span>-color'], '<span class="hljs-number">2.0</span>s ease-<span class="hljs-keyword">in</span> <span class="hljs-number">2</span>s')
}
